                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <a href="#" data-toggle="modal" data-target="#addAdmModal" class="atalho">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">MEUS DADOS</div>
                                        </a>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <a href="#" class="atalho" data-target="#contatoModal" data-toggle="modal">
                                            <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">MEUS AGENDAMENTOS</div>
                                        </a>
                                    </div>
                                    <div class="col-auto">
